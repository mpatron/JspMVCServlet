...
public abstract class AbstractEvent {
   ...
   */
  public final <T> T loadJspBean2(final HttpServletRequest request, final Class<T> classe) throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException {
    ...
    for (PropertyDescriptor propertyDescriptor : pds) {
      if("java.lang.String[]".equals(propertyDescriptor.getPropertyType().getCanonicalName())) {
        ...
        new IllegalArgumentException("Type non supportee par le marshalling MVC : " + propertyDescriptor.getPropertyType().getCanonicalName());
      }
    }
    return returnValue;
  }
  ...
  public final <T> T loadJspBean(final HttpServletRequest request, final Class<T> classe) throws InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
    final T returnValue = classe.newInstance();
  ...
  private Object createInstance(String propertyType) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
    Object returnValue=null;
    if(("boolean".equals(propertyType) || ("java.lang.Boolean".equals(propertyType)))) {
      ...
      returnValue=new Short((short)0);
    } else {
      returnValue=Class.forName(propertyType).newInstance();
    }
    return returnValue;    
  }
   ...
   * @throws IOException
   */
  public abstract void process(final ServletContext context, final HttpServletRequest request,
...
//      }
////    } catch (Throwable t) {
////      final NumberFormatException nfe = new NumberFormatException(StringUtils.EMPTY + chaine
////          + " n'est pas un réel.");
////      throw nfe;
////    }
//    return returnValue;
